  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden opacity-20">
        ...
        ></div>
        <div className="absolute top-20 right-20 w-60 h-60 bg-pink-500 rounded-full filter blur-[120px]"></div>
        <div className="absolute bottom-40 left-20 w-60 h-60 bg-purple-500 rounded-full filter blur-[120px]"></div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-900/90 to-black/90 p-8 shadow-xl border border-white/10 h-full">
              {/* Manga-style speech bubble */}
              <div className="relative mb-8 p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="flex-shrink-0 bg-pink-500/20 p-3 rounded-lg">
                    <svg
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-white">メール • Email</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-white">場所 • Location</h4>
                    <p className="mt-1 text-gray-300">Tokyo, Japan</p>
                  </div>
                </div>

                {/* Manga-style social links */}
                <div className="pt-6 mt-6 border-t border-white/10">
                  <h4 className="text-lg font-medium text-white mb-4">ソーシャル • Social</h4>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-900/90 to-black/90 p-8 shadow-xl border border-white/10">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:ring-2 focus:ring-pink-500/50 focus:border-pink-500/50 text-white"
                ...
                <div>
                  <button
                    ...
                    className="w-full px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-600 text-white font-medium rounded-lg hover:from-pink-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-pink-500/50 transition-all disabled:opacity-70"
                  >
                    {isSubmitting ? (
